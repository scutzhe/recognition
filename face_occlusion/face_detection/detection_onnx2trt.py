...
def modify_onnx(onnxfile):
    ...
    onnx.save(onnx_model, "./model/facedetection.onnx")


def convert_trt(onnx_file_path, output_trt=None, batchsize=8):
    if output_trt is None:
        output_trt = onnx_file_path.replace(".onnx", ".trt")
...
if __name__ == "__main__":
    modify_onnx("./model/facedetection.onnx")
    convert_trt("./model/facedetection.onnx")
