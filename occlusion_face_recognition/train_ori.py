...
from config_ori import configurations
...
if __name__ == '__main__':
    ...
    dataset_train = datasets.ImageFolder(os.path.join(DATA_ROOT, 'imgs_subset'), train_transform)
    ...
    if BACKBONE_NAME.find("IR") >= 0:
        backbone_paras_only_bn, backbone_paras_wo_bn = separate_ir_bn_paras(
    ...
    NUM_EPOCH_WARM_UP = NUM_EPOCH // 50  # use the first 1/25 epochs to warm up
