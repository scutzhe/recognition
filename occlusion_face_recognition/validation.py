...
# ----------------    -------    --------    -----------
# 2019.10.15 16:58    samon      v0.1        creation
...
if __name__ == '__main__':
    ...
    train_transform = transforms.Compose([
        ...
        # for more build-in online data augmentation
    ...
    dataset_train = MaskImageFolder(image_dir=os.path.join(DATA_ROOT, 'train', 'imgs'),
    ...
    for epoch in range(NUM_EPOCH):  # start training process
        ...
        for inputs, masks_gt, labels in tqdm(iter(train_loader)):
            ...
            if len(backbone_out) == 2:
                ...
                identify_losses.update(loss.data.item(), inputs.size(0))
