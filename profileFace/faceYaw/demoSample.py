...
def angleDetection(img:np.array):
    ...
    face_cascade = cv2.CascadeClassifier("face_detector/lbpcascade_frontalface_improved.xml")
    ...
    input_img = draw_results(detected,img,faces,ad,img_size,img_w,img_h,model,time_detection,time_network,time_plot)
    cv2.imwrite('yawResult/'+str(img_idx)+'.png',input_img)
