...
parser.add_argument('--resume', default='/home/zhex/pre_models/dream/cfp_res50_end2end.pth.tar', type=str, metavar='PATH',
...
def extract_feat(arch, resume):
    ...
    frontal_list_file = '/home/zhex/data/CFP/protocol/frontal_list_nonli.txt'
    ...
    caffe_crop = CaffeCrop('test')
    profile_list_file = '/home/zhex/data/CFP/protocol/profile_list_nonli.txt'
...
if __name__ == '__main__':
    ...
    infos = [('resnet50_naive', '/home/zhex/pre_models/cfp_res50_naive.pth.tar'),
            ('resnet50_end2end', '/home/zhex/pre_models/cfp_res50_end2end.pth.tar')]
