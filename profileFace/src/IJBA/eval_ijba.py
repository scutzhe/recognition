...
def extract_feat(arch, model_path, yaw_type):
    ...
    infos = [ ('/home/zhex/data/IJBA/align_image_11', 'ijb_a_11_align_split', 'frame'),
               ('/home/zhex/data/IJBA/align_image_11', 'ijb_a_11_align_split', 'img')
               # ('/home/zhex/data/IJBA/align_image_1N', 'split', 'gallery'),
               # ('/home/zhex/data/IJBA/align_image_1N', 'split', 'probe')
              ]
...
def main():
    infos = [ ['resnet18_naive', '/home/zhex/pre_models/dream/ijba_res18_naive.pth.tar', 'nonli'],
              # ['resnet18_end2end', '/home/zhex/pre_models/dream/ijba_res18_end2end.pth.tar', 'nonli']
              ]
