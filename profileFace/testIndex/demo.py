...
def extract_feat(arch, model_path):
    ...
    infos = [('/home/zhex/test_result','face_gallery_probe','gallery'),
             ('/home/zhex/test_result','face_gallery_probe','probe')]
...
def main():
    infos = [# ['resnet18_naive', '/home/zhex/pre_models/dream/ijba_res18_naive.pth.tar','nonli']
             ['resnet18_end2end', '/home/zhex/pre_models/dream/ijba_res18_end2end.pth.tar']
            ]
