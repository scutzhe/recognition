...
# load_meta_data(gallery_file, 'gallery')
...
def test_recog(model_type):
    protocol_dir = '/home/zhex/data/IJBA/protocol_1N'
    align_img_dir = '/home/zhex/data/IJBA/align_image_1N'
    split_num = 1
    ...
    for split in range(1, split_num+1):
        ...
        # feature extraction gallery and probe
...
if __name__ == '__main__':
    test_recog(model_type='resnet18')
